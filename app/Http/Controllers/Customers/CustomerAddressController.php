...
class CustomerAddressController extends Controller
{
    ...
    public function storeAddress(Request $request, $customer_id, $type = 'individual')
    {
        ...
        // ✅ Check if any existing address exists
        $existingAddressesCount = CustomerAddress::where('customer_id', $customer_id)
        ...
        if ($existingAddressesCount === 0) {
            ...
            // If user marks a new one as primary, unset others
