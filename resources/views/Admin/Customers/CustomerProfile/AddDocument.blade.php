...
@section('title', 'Home | Customers | Documents')

@section('content')
<div class="page-content">
    <x-breadcrumb
        title="Documents"
        :links="['Home' => 'Admin.Dashboard', 'Customers' => 'customers.List' ,'Documents'=>'' ]" />
    ...
    <h5>Upload customer Documents</h5>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#documentForm").on("submit", function(e) {
            ...
            $.ajax({
                type: "POST",
                url: `${baseUrl}/${customer_id}/documents/individual/store`,
                data: formData,
                processData: false,
                contentType: false,
                success: function(response) {
                    ...
                    if (response.success) {
                        ...
                        Swal.fire({
                            ...
                            updateProgress(80);
                            window.location.href = `${baseUrl}/${customer_id}/Media`;
                        });
                    }
                },
                error: function(xhr) {
