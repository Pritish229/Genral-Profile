...
@section('title', 'Home | customers | Manage Business Online Profiles')
...
<script>
    ...
    function getApiUrl(path = '') {
        return `${baseUrl}/${customer_id}/business/OnlineProfile${path}`;
    }

    // ======== LOAD BUSINESS PROFILES ========
    function loadBusinessProfiles() {
        $.get((`${baseUrl}/${customer_id}/${business_id}/business/OnlineProfile/List/`), function(res) {
            let rows = '';
