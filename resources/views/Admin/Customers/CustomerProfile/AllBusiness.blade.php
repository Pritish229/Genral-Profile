...
@section('title', 'Home | customer | All Business')
        ...
        <div class="row">
            <div class="col-12">
                <div class="card p-3">
                        ...
                        <table id="business-customer-table" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    <th>customer ID</th>
                                    <th>Legal Name</th>
...
$(document).ready(function() {
    ...
    if (!$.fn.DataTable.isDataTable('#business-customer-table')) {
        $('#business-customer-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: `{{ route('customers.totalBusiness') }}`,
            columns: [
