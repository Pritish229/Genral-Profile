...
@section('title', 'Home | Customers | Media')

@section('content')
<div class="page-content">
    <x-breadcrumb
        title="Media"
        :links="['Home' => 'Admin.Dashboard', 'Customers' => 'customers.List' ,'Media'=>'' ]" />
...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#documentForm").on("submit", function(e) {
            ...
            $.ajax({
                type: "POST",
                url: `${baseUrl}/${customer_id}/media/individual/store`,
                data: formData,
                processData: false,
                contentType: false,
                success: function(response) {
                    ...
                    if (response.success) {
                        ...
                        Swal.fire({
                            ...
                            window.location.href = `${baseUrl}/${customer_id}/individual/OnlineProfile`;
                        });
                    }
                },
                error: function(xhr) {
