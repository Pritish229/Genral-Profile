...
<div class="page-content">
  ...
  <form id="customerForm" autocomplete="on" enctype="multipart/form-data">
    @csrf
    <div class="row g-3">
      <h5>Customer info </h5>
      ...
      <div class="col-md-8">
        <div class="row">
          ...
          <div class="col-md-6">
            <x-inputbox id="primary_email" label="Primary Email" type="email" placeholder="Enter customer email" name="primary_email"
              value="{{ old('primary_email') }}" :required="false" helpertxt="customer Email" />
          </div>
...
<script>
  jQuery(function($) {
    ...
    function setProgress(value) {
      localStorage.setItem("customerProgress", value);
      $('#progress-bar').css('width', value + '%').text(value + '%');
    }

    function getProgress() {
      return parseInt(localStorage.getItem("customerProgress") || 0, 10);
    }
