...
@section('title', 'Home | customers | Manage Online Profiles')

@section('content')
<div class="page-content">
    <x-breadcrumb
        title="Manage Online Profiles"
        :links="['Home' => 'Admin.Dashboard', 
        'Customers' => 'customers.List',
        'Customer Details' => ['customers.viewDetails', ['id' => $id]], 'Manage Online Profiles' => '']" />
...
<script>
    ...
    function getApiUrl(path) {
        return `${baseUrl}/${customer_id}/individual/OnlineProfile${path}`;
    }
