...
<script>
    ...
    function loadDocuments() {
        const url = "{{ url('vendors') }}/" + vendorId + "/documents/individual" ;
    ...
    $('#documentForm').on('submit', function(e) {
        ...
        let url = "{{ url('vendors') }}/" + vendorId + "/documents/individual/store";
        let method = 'POST';

        if (docId) {
            url = "{{ url('vendors') }}/" + vendorId + "/documents/individual/" + docId;
    ...
    $(document).on('click', '.editDoc', function() {
        ...
        const url = "{{ url('vendors') }}/" + vendorId + "/documents/individual/" + id;
        $.get(url, function(res) {
            const d = res.data;
