(function ($) {
    ...
    $.fn.imageUploader = function (options) {
        ...
        let defaults = {
            ...
            multiple: true // default is true for multiple images
        };
        ...
        let createContainer = function () {
            ...
            let $container = $('<div>', {class: 'image-uploader'}),
                ...
                $input = $('<input>', {
                    ...
                    name: plugin.settings.imagesInputName + (plugin.settings.multiple ? '[]' : ''), // Correct name attribute
                    multiple: plugin.settings.multiple ? '' : null
                }).appendTo($container),
        ...
        let createImg = function (src, id, preloaded) {
            ...
            $button.on("click", function (e) {
                ...
                // If it is not a preloaded image
                ...
                // If there are no more uploaded files
                ...
                // If multiple is false, reset the input
        ...
        let setPreview = function ($container, files) {
            ...
            // If multiple is false, clear the container and dataTransfer
            if (!plugin.settings.multiple) {
                $uploadedContainer.empty(); // Clear previous images
                dataTransfer = new DataTransfer(); // Clear dataTransfer
            }
